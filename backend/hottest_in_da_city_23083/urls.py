"""hottest_in_da_city_23083 URL Configuration
...
admin.site.site_header = "Hottest In Da City"
admin.site.site_title = "Hottest In Da City Admin Portal"
admin.site.index_title = "Hottest In Da City Admin"

# swagger
api_info = openapi.Info(
    title="Hottest In Da City API",
    default_version="v1",
    description="API documentation for Hottest In Da City App",
)
